  ...
  const LEARN_PROMPTS = [
    {
      ...
      task: "把未来 90 天确定要花的钱列出来，单独放进现金管理账户。",
      review: "如果这笔投资亏损 10%，是否会影响吃饭、房租、学费或考试报名？",
    },
    {
      title: "写下买入理由",
      prompt: "如果不能用一句话说明为什么买，就先观察一周。",
      task: "用一句话写清楚买入理由，再写一条退出条件。",
      review: "这个理由是基于估值、现金流和周期，还是只因为同学推荐或短期上涨？",
    },
    {
      title: "看最大回撤",
      prompt: "想象账户短期下跌 20%，你会加仓、持有还是睡不着？",
      task: "给每个高波动产品写一个可接受亏损金额，而不是只写百分比。",
      review: "如果真的跌到这个金额，你还会按计划执行吗？",
    },
    {
      title: "分清收益来源",
      prompt: "货币基金靠流动性，债基吃利率和信用，权益基金吃企业盈利。",
      task: "给持仓标注收益来源：流动性、利率、信用、盈利、估值或汇率。",
      review: "你是否能说出这个产品最怕哪一种风险？",
    },
  ];
